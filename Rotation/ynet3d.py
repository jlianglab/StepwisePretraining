...
def ynet_model_3d(input_shape, pool_size=(2, 2, 2), n_labels=1, deconvolution=False,
    ...
    layer1 = create_convolution_block(input_layer=cls_input, n_filters=512,
                                      batch_normalization=batch_normalization, layer_depth=num_layer)
    # num_layer += 1
    # layer2 = create_convolution_block(input_layer=layer1, n_filters=512,
    #                                   batch_normalization=batch_normalization, layer_depth=num_layer)
...
if __name__ == '__main__':
    model=ynet_model_3d((1, 64, 64, 32),batch_normalization=True,encoder_weights="/mnt/dfs/fhaghigh/visual_word_learning/proxy_task/3d_LUNA/Models/proxy_Img_label/proxy_r1.h5")
    model.summary()
